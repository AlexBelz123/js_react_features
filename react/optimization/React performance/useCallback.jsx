...
// lets say Child component have a lot of rerenders and cuse bad UX for some reason
// so we want to prevent this bad UX and make less rerenders, right? How we can achieve it?
// of cause we can rewrite our code logic etc, but in our case we will use React.memo with react.useCallback
...
// if props are the same - the component will not be rerendered
...
// this reference and prevent child component from unnecessary rerender (the reference can be changed if we will provide some dependencies to empty array (line 13))
